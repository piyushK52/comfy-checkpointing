NOTE: This code has been adapted from [Workflow Checkpointing](https://github.com/AustinMroz/ComfyUI-WorkflowCheckpointing), all the credit goes to @AustinMroz
